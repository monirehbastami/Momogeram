        ...
        <div className='flex px-3 py-1 items-center gap-1 justify-between'>
            <div className='flex gap-2'>
                <div className='relative'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill={`${currentContact?.isActive ? '#d946ef':'#7b00ff'}`} stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" aria-hidden="true"  viewBox="0 0 24 24"><circle cx="12" cy="13" r="5"/></svg>
                    </div>
                </div>
