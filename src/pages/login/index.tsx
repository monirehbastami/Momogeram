  ...
  return (
    <div className="flex justify-center items-center h-[calc(100vh-120px)]">
      <form
        ...
        className="flex flex-col items-center justify-center py-10 px-5 bg-light-content [&_input]:mt-5 [&_button]:mt-5 rounded-lg w-4/5 lg:w-1/2 xl:w-4/5 h-1/2"
      >
        <h1 className="text-center font-bold text-lg text-dark-content">Login Form</h1>
        <Input
          {...register("username", { required: true })}
          placeholder="username" variant="Primary"
        />
        <Input
          type="password"
          {...register("password", { required: true })}
          placeholder="password"variant="Primary"
        />
        <Input
          type="submit"
